...
<style>
  ...
  .actions { display: flex; align-items: center; gap: 9px; }.actions .icon-button.active{color:#00e5ff;border-color:#00e5ff}.actions .admin-entry.active{color:#ff3fd8;border-color:#ff3fd8}.badge-wrap { position: relative; }.badge-wrap span { position: absolute; top: -6px; right: -6px; min-width: 18px; height: 18px; padding: 0 5px; display: grid; place-items: center; border-radius: 99px; color: white; background: #ff3fd8; border: 2px solid #02040d; font-size: 9px; font-weight: 800; }.sign-in, .sign-out, .admin-entry, .sell { min-height: 44px; padding-inline: 17px; font-size: 13px; }.menu { display: none; }
  ...
  @media (max-width: 900px) { .topbar { left: 0; height: 74px; padding: 0 14px; }.mobile-brand { display: block; }.desktop-nav, .desktop-action, .sign-in, .sign-out { display: none; }.menu { display: inline-grid; } }
</style>
